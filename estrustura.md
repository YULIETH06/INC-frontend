...
| `updatePersonnelRequisitionCandidate(requisitionId, candidateId, data)` | Actualiza el tipo de identificación, número de identificación, nombre, observación o la hoja de vida de un candidato.                                                                                                                                         |
...
| `closePersonnelRequisitionCandidates(requisitionId)`                    | Cierra el proceso de cargue de candidatos de la requisición. Cambia el estado a `CERRADA`, registra la fecha de cierre y bloquea temporalmente las acciones de registro, edición y eliminación.                                                               |
| `reopenPersonnelRequisitionCandidates(requisitionId)`                   | Reabre un cargue previamente cerrado. Cambia el estado nuevamente a `ABIERTA`, establece `candidateSubmissionClosedAt` en `null` y permite al Auxiliar de Talento Humano volver a registrar, editar o eliminar candidatos.                                    |
...
Este archivo contiene las reglas de validación utilizadas para registrar y actualizar candidatos dentro de una requisición.
...
La separación entre ambos esquemas evita exigir nuevamente el archivo cuando solamente se modifican los datos personales u observaciones de un candidato existente.
