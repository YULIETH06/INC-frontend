...
| `savePersonnelCandidateTechnicalEvaluation(candidateId, data)` | Registra las calificaciones de entrevista y examen de la Fase 4. Las notas pueden guardarse de forma independiente y, cuando ambas existen, la evaluación queda pendiente de aprobación. |
